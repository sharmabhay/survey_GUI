...
public class GradeLevelrecent {
    ...
    public static void GradeLevels() {
        ...
        okButton1.addActionListener(new ActionListener() {
            ...
            try {
                FileWriter fn = new FileWriter("C:\\Users\\salma\\Desktop\\Java Files\\Unit Project\\onlyGrades.txt", true);
            ...
            try{
            FileWriter usersChoice = new FileWriter(
                "C:\\Users\\salma\\Desktop\\Java Files\\Unit Project\\GradeLevelData.txt", true);
            ...
            try {
                FileReader fr = new FileReader ("C:\\Users\\salma\\Desktop\\Java Files\\Unit Project\\GradeLevelData.txt");
            ...
            try {
                FileReader fr = new FileReader ("C:\\Users\\salma\\Desktop\\Java Files\\Unit Project\\onlyGrades.txt");
                BufferedReader br = new BufferedReader(fr);
                int grade9Counter = 0;
                int grade10Counter = 0;
                int grade11Counter = 0;
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "~Statistics for the Grade of Each Student~" + "\n" + "Students in Grade 9: " + " " + grade9Counter + "Students in Grade 10: " + " " + grade10Counter + "Students in Grade 11" + " " + grade11Counter + "Students in Grade 12" + " " + grade12Counter);
                    br.close();
                } catch (IOException e1) {
                    e1.printStackTrace();
                }
