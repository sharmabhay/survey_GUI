    ...
    public void frame() {
        ...
        studentQ1.addActionListener(new ActionListener(){ 
            public void actionPerformed(ActionEvent s){
                    try {
                        File myObj = new File("C:\\Users\\salma\\Desktop\\Java Files\\Unit Project\\QuestionOneData.txt");
                        //Reading the file
        ...
        teacherQ1.addActionListener(new ActionListener(){ 
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    //Closing frame, bufferedwriter, and scanner
                    frameQ1.setVisible(false);
                    JOptionPane.showMessageDialog(null, studentCounterQ1 + " students and " + teacherCounterQ1 +" teachers have been surveyed so far.");
