...
public class KalQuestions {
    ...
    File file1 = new File(dir + "qn_7_student.txt"); // import file for question 1
    ...
    if (file1.createNewFile()) {
        ...
        try {
            FileWriter fw1 = new FileWriter(dir + "qn_7_student.txt",true);
            FileWriter fw2 = new FileWriter(dir + "qn_8_student.txt",true);
            FileWriter fw3 = new FileWriter(dir + "qn_9_student.txt",true); //creates file writer for 3 files
    ...
    public static void countQuestion7() throws IOException {
        FileReader fr7 = new FileReader (dir + "qn_7_student.txt");
    ...
    public static int countQuestion8() throws IOException {
        FileReader fr8 = new FileReader (dir + "qn_8_student.txt");
